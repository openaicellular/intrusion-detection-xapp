...
class multi_ue(gr.top_block):
    ...
    def __init__(self):
        ...
        self.zeromq_req_source_0_0_0_0 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:2011', 100, False, -1)
        ...
        self.zeromq_rep_sink_1_1_1 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2600', 100, False, -1)
        ...
        self.blocks_multiply_const_vxx_0_1_1_0 = blocks.multiply_const_cc(0.08)
        self.blocks_multiply_const_vxx_0_1_0_1 = blocks.multiply_const_cc(0.08)
        self.blocks_multiply_const_vxx_0_1_0_0 = blocks.multiply_const_cc(0.05)
        self.blocks_multiply_const_vxx_0_1_0 = blocks.multiply_const_cc(0.08)
        self.blocks_multiply_const_vxx_0_0_1 = blocks.multiply_const_cc(0.05)
        self.blocks_multiply_const_vxx_0_0_0 = blocks.multiply_const_cc(0.05)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_1_1_0, 0), (self.blocks_add_xx_0, 3))
        self.connect((self.blocks_multiply_const_vxx_0_1_0_0, 0), (self.zeromq_rep_sink_1_1_0, 0))

        self.connect((self.blocks_multiply_const_vxx_0_1_0_1, 0), (self.zeromq_rep_sink_1_1_1, 0))
        ...
        self.connect((self.zeromq_req_source_0_0_0_0, 0), (self.blocks_multiply_const_vxx_0_1_1_0, 0))
